...
import { useResetPassword } from "@/hooks/guide/usePassword"
        ...
        <Card className="shadow-xl border-none bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm">
          ...
          <CardContent>
            <form onSubmit={formik.handleSubmit} className="space-y-6">
              ...
              <Button
                type="submit"
                className="w-full py-2 px-4 rounded-md text-lg font-semibold bg-purple-600 hover:bg-purple-700 text-white transition-colors duration-200"
              >
                Reset Password
              </Button>
            </form>
