          ...
          <CardHeader className="border-b border-slate-200 bg-gradient-to-r from-slate-50 to-white px-8 py-6">
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <CardTitle className="text-xl font-bold text-slate-900">Users Directory</CardTitle>
                  <p className="text-sm text-slate-600 mt-1">Comprehensive user management system</p>
                </div>
              </div>
              ...
              <Table>
                <TableHeader>
                  <TableRow className="border-b border-slate-200 bg-slate-50/50 hover:bg-slate-50/50">
                    <TableHead className="w-16 font-bold text-slate-700 py-4 text-center">Sl.No</TableHead>
                    <TableHead className="font-bold text-slate-700 text-center">User Details</TableHead>
                    <TableHead className="font-bold text-slate-700 text-center hidden sm:table-cell">Contact</TableHead>
                    <TableHead className="font-bold text-slate-700 text-center hidden md:table-cell">Phone</TableHead>
                        ...
                        <TableCell className="py-6">
                          <div className="flex items-center gap-4">
                            ...
                            <div className="min-w-0 flex-1">
                              ...
                              <p className="text-sm text-slate-600 sm:hidden mt-1 truncate">{user.email}</p>
