      ...
      <CardContent className="p-6">
        <Tabs defaultValue="inclusions" className="w-full">
          <TabsList className="grid w-full grid-cols-4 bg-slate-800 border border-slate-700">
            <TabsTrigger
              value="inclusions"
              className="data-[state=active]:bg-purple-400 data-[state=active]:text-slate-900 text-slate-400"
            >
              Inclusions
            </TabsTrigger>
            <TabsTrigger
          ...
          <TabsContent value="inclusions" className="mt-6">
            <div className="space-y-3">
              <h3 className="text-lg font-semibold text-slate-200 mb-4">What's Included</h3>
          ...
          <TabsContent value="exclusions" className="mt-6">
            <div className="space-y-3">
              <h3 className="text-lg font-semibold text-slate-200 mb-4">What's Not Included</h3>
              <ul className="space-y-2">
          ...
          <TabsContent value="cancellation" className="mt-6">
            <div className="space-y-3">
              <h3 className="text-lg font-semibold text-slate-200 mb-4">Cancellation Policy</h3>
              <div className="prose prose-slate max-w-none">
