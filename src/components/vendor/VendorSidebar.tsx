...
const VendorSidebar: React.FC = () => {
  ...
  const {firstname,email} = useSelector((state : RootState) => state.vendor.vendor)
  const dispatch = useDispatch();
  const navigate = useNavigate();

  const navItems: NavItem[] = [
    { id: "packages", label: "Packages", icon: Package, path: "/vendor/packages" },
    { id: "users", label: "Users", icon: Users, path: "/vendor/users" },
    { id: "trams", label: "Trams", icon: Zap, path: "/vendor/trams" },
    { id: "actions", label: "Actions", icon: Activity, path: "/vendor/actions" },
    { id: "reviews", label: "Reviews", icon: Star, path: "/vendor/reviews" },
    { id: "queries", label: "Queries", icon: MessageSquare, path: "/vendor/queries" },
