    ...
    >
      ...
      >
        <div
          ...
          className="absolute left-1/2 p-4 top-1/2  flex justify-start items-start    bg-white group-hover/pin:border-gray-300 transition duration-700 overflow-hidden"
        >
