...
// import { Star, Send, MapPin, Award, Users } from "lucide-react"
...
//                       <div className="flex gap-1">{renderStars(guideIn)}</div>
//                       <span className="text-gray-500">({guideInfo.totalReviews} reviews)</span>
//                     </div> */}
//                   </div>
//                 </div>
...
//               <p className="text-gray-600">Be the first to share your experience with this guide!</p>
//             </div>
//           )}
//         </div>
//       </div>
