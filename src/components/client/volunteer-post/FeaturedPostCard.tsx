...
export function FeaturedPostCard({
  ...
  return (
    ...
    >
      <Card 
        className="overflow-hidden hover:shadow-xl transition-all duration-500 border border-slate-200 hover:border-[#2CA4BC]/30 bg-white h-full flex flex-col cursor-pointer"
      ...
      >
        ...
        <div className="h-48 relative overflow-hidden">
          ...
          {post.offersGuideService && (
            <div className="absolute top-3 right-3 px-2 py-1 bg-[#2CA4BC]/90 backdrop-blur-md rounded-full">
        ...
        <div className="flex-1 p-6 flex flex-col">
          ...
          {/* Stats */}
          <div className="flex items-center justify-between text-sm text-slate-500 mb-4 mt-auto">
          ...
          <Button
            onClick={handleViewPost}
            className="w-full bg-gradient-to-r from-[#2CA4BC] to-[#1a5f6b] text-white py-2.5 hover:shadow-lg hover:shadow-[#2CA4BC]/25 transition-all duration-300 flex items-center justify-center gap-2 text-sm font-medium"
          >
