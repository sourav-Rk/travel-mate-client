export const VENDOR_API = {
  ...
  ASSIGN_GUIDE_TO_PACKAGE: (packageId: string) => `/vendor/package/${packageId}/assign-guide`,
  ...
  GET_BOOKING_DETAILS: (bookingId: string) => `/vendor/bookings/users/${bookingId}`,
  SEND_PAYMENT_ALERT: (packageId: string) => `/vendor/bookings/${packageId}/payment-alert`,
  GET_CANCELLATION_REQUESTS : '/vendor/cancellation-requests',
  GET_CANCELLATION_BOOKING_DETAILS:(bookingId : string) =>  `/vendor/bookings/${bookingId}/cancelled`,
  VERIFY_CANCELLATION_REQUEST : (bookingId : string) => `/vendor/bookings/verify-cancellation/${bookingId}`,

  // ================== NOTIFICATIONS ==================
  GET_NOTIFICATIONS: "/vendor/notifications",
  MARK_NOTIFICATION_READ: (notificationId: string) => `/vendor/notifications/${notificationId}`,
